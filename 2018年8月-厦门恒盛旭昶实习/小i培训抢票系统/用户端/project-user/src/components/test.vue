<template>
  <div class="home1" style="width: 100%">
    ...
    <div style="margin-top: 5vh;width: 94%;margin-left: auto;margin-right: auto;opacity:0.9;">
      <el-tabs type="border-card" tabPosition="left" style="height: 65vh;padding: 0;width: 100%">
        <el-tab-pane v-for="(eachShop,index) in shops" :key="index" :label="eachShop.name" style="padding: 0;width: 100%">
          <div style="">
          <el-collapse v-model="activeNames" accordion @change="openShop" style="height: 100%;">
            <el-collapse-item v-for="(shop,index1) in eachShop.shops" :key="index1" :name="shop.shopid">
  ...
  methods: {
    ...
    load:function(){
      ...
      this.$axios({
        ...
        _this.$data.shops=response.data;
