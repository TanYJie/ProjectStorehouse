        ...
        <div>
          <div style="margin-top:20px;margin-left: 30px;width: 400px;">
            <el-breadcrumb separator-class="el-icon-arrow-right" style="font-size: 18px">
              ...
              <el-breadcrumb-item>编辑教师信息</el-breadcrumb-item>
            </el-breadcrumb>
          </div>
  ...
  export default {
    ...
    methods: {
      loadTeacher:function () {
        let _this=this;
        var teacherId=_this.$route.query.teacherId;
        var teacherAccount=_this.$route.query.teacherAccount;
        var teacherName=_this.$route.query.teacherName;
        var teacherEmail=_this.$route.query.teacherEmail;
        _this.$data.formId=teacherId;
        _this.$data.formAccount=teacherAccount;
        _this.$data.formAccountPlaceholder=teacherAccount;
        _this.$data.formName=teacherName;
        _this.$data.formNamePlaceholder=teacherName;
        _this.$data.formEmail=teacherEmail;
        _this.$data.formEmailPlaceholder=teacherEmail;
      ...
      confirmEdit:function () {
        ...
        _this.$axios({
          method:'put',
          url:'/teacher/'+parseInt(_this.$data.formId)+'/information',
          header:{
