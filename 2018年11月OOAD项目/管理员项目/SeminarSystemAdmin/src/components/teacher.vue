        ...
        <div>
          ...
          <div id="search">
            <el-form :inline="true" :model="formInline" label-width="100px" style="height:45px" >
              <el-form-item style="margin-left: 40px">
                <el-input prefix-icon="el-icon-search" v-model="formInline.name" placeholder="请输入教工号/姓名"></el-input>
              </el-form-item>
          ...
          <div>
            <el-table :data="tableData.slice((currentPage-1)*pageSize,currentPage*pageSize)"
                      ...
                      id="myTable">
              <el-table-column prop="account" label="教工号" min-width="200px" align="center" sortable></el-table-column>
    ...
    methods: {
        ...
        this.$axios({
          ...
          for(var i=0;i<response.data.length;i++){
            var newItem={
              ...
              name:response.data[i].teacherName,
      ...
      confirmReset:function(index, row){
        ...
        this.$confirm('确定要重置 '+teacherName+' 的密码吗?', '重置密码', {
          ...
          console.log(newIndex);
          console.log(row);
          _this.handleReset(newIndex,row);
        }).catch(() => {
          _this.$message({
            type: 'info',
            message: '已取消重置'
      ...
      handleReset:function (index, row) {
        ...
        this.$axios({
          method:'put',
          url:'/teacher/'+userId+'/password',
        }).then(function (response) {
          console.log("重置的返回值："+response.data);
      ...
      searchByName:function(name){
        ...
        this.$axios({
          method:'get',
          url:'/teacher/searchteacher?identity='+name,
        }).then(function (response) {
          console.log(response.data);
          _this.$data.tableData = [];
          for(var i=0;i<response.data.length;i++){
